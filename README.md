# Creators Dashboard — Evaluator SPA

This repository contains a Vue 3 single-page application (SPA) for the evaluator service.

## Prerequisites
- Creators Dashboard [Developers Edition](https://github.com/coaigo/impact/blob/main/CONTRIBUTING.md)
- Developer [SPA Standard Prerequisites](https://github.com/coaigo/impact/blob/main/DeveloperEdition/standards/spa_standards.md)
...
**Note**: This template uses `@coaigo/impact_spa_utils` for reusable components, composables, and utilities. See the [impact_spa_utils README](../impact_spa_utils/README.md) for complete documentation on available components (`AutoSaveField`, `AutoSaveSelect`, `ListPageSearch`), composables (`useResourceList`, `useErrorHandler`, `useRoles`), and utilities (`formatDate`, `validationRules`).
...
This template uses components and composables from `@coaigo/impact_spa_utils`:
- **Components**: `AutoSaveField`, `AutoSaveSelect`, `ListPageSearch`
- **Composables**: `useResourceList`, `useErrorHandler`, `useRoles`
- **Utilities**: `formatDate`, `validationRules`

See the [impact_spa_utils README](../impact_spa_utils/README.md) for complete documentation and usage examples.
